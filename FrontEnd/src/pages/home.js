                  ...
                  <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-6">
                      <div className="container-fluid">
                          <div className="row mb-1">
                              ...
                              <div className="col-5">
                                  <button className="btn center w-100 btn-success">
                                      ✓
                                  </button>
                              </div>
                              <div className="col-1">
                          ...
                          <div className="row">
                              ...
                              <div className="col-10">
                                  <div id="recommended" className="carousel slide">
                                      <div className="carousel-inner">
                                          <div className="carousel-item active rounded-5">
                                              <div className="container bg-light rounded-5" style={{ height: "800px" }}>
                                                  <div className="row">
                                                      <img alt="bron" className="img-fluid rounded-5 mt-2 h-50" src="https://encrypted-tbn2.gstatic.com/licensed-image?q=tbn:ANd9GcTcxZiB0z8hcQ16f_jOGJRB6lYuNPIQRcl6vnL6T3kMpV1TXRAuI7o51GTgFE688xe5D0AAthc9a5P8XxfD4m7cYTKcB0CwDTuXiQqOa4pjNQDgyaMgOfDHl6T5MKUtryTQHekKax8EmIru" />
                                                  </div>
                                                  <div className="row">
                                                  ...
                                                  <div className="row">
                                                      <div className="col-12">
                                                          <h5 className="text-left ms-1 mt-1 text-dark">
                                                              Description Bio whateverDescription Bio whateverDescription Bio whateverDescription Bio whateverDescription Bio whateverDescription Bio whateverDescription Bio whateverDescription Bio whatever
                                                          </h5>
                                                      </div>
